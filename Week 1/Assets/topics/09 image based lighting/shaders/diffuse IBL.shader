    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                float3 indirectDiffuse = texCUBElod(_IBL, float4(normal, DIFFUSE_MIP_LEVELS));
                float3 diffuse = indirectDiffuse.rgb;

                diffuse = surfaceColor * (directDiffuse * lightColor + indirectDiffuse);
