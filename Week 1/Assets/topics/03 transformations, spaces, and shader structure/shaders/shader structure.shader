...
Shader "examples/week 3/shader structure"
{
    ...
    SubShader
    {
        ...
        // you will often see tags here. we won't go into too much detail about tags in this class, but we will use them in a limited way later on. your shader will work without a tag. if you want to learn more you can here: https://docs.unity3d.com/Manual/SL-SubShaderTags.html
